...
<head>
    ...
    <title>Valentine By ABD💘</title>

    <!-- ✅ Only font change (Poppins like the screenshot theme) -->
    ...
    <style>
        :root {
            /* ✅ same vibe as the screenshot: soft pink background */
            --pink1: #fde2ea;
            --pink2: #fbe7ef;

            /* ✅ font colors like screenshot */
            --ink: #7a1f3d;      /* main text */
            --muted: #b44a6f;    /* sub text */
        ...
        * {
        ...
        body {
            ...
            background:
                ...
                linear-gradient(135deg, #fff0f6, #fde7f2);
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="wrap">
        <div class="card" id="askCard">
            ...
            <h1><span class="name" id="who">Shivani</span>KAYCEE😍,<br />will you be my Valentine?
            ...
            <div class="row" id="playground">
                <!-- ✅ DO NOT change yes-slot / no-slot structure -->
        ...
        <div class="card hidden" id="yayCard">
            ...
            <div class="gifbox">
                <img alt="Celebration" src="E:\ABD\KAYCEE.jpeg" />
            </div>

            <div class="love">I love you ❤️</div>
            <div class="love" id="whoself">I love you ❤️</div>
    ...
    <script>
        ...
        document.getElementById("whoself").textContent = `~ ABDUR❤️`;
